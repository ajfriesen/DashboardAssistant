...
<!-- Verify these links resolve: enable GitHub Sponsors for @ajfriesen, and set
     the Ko-fi link (or swap it for the one-off platform you actually use). -->
...
Sponsorship isn't abstract — it pays for the things that move the project
forward:

- **Test hardware.** Panels, mini-PCs and single-board computers to develop and
